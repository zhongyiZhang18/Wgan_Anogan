...
def load_model():
    ...
    d.load_weights('./saved_model/whited_Wdiscriminator.h5')
    g.load_weights('./saved_model/whited_Wgenerator.h5')
    return g, d
...
def train(BATCH_SIZE, X_train):
    ...
    for epoch in range(25):
        ...
        g.save_weights('saved_model/whited_Wgenerator.h5', True)
...
def anomaly_detector(g=None, d=None):
    ...
    model.compile(loss=sum_of_residual, loss_weights= [0.00, 1.00], optimizer='rmsprop')
...
### anomaly detection
def compute_anomaly_score(model, x, iterations=200, d=None):
